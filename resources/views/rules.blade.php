...
<div class="rule-container">
    ...
    <div class="rule-column">
        <div class="rule-card">
            <img src="" alt="Ikhfaa">
            <p><strong>Rule 4:</strong> The Tajweed rule of Al-Ikhfaa is as follows: If any of the fifteen Arabic 
            letters of Ikhfaa are preceded by An-noon As-sakinah or At-tanween, then, An-noon As-sakinah and At-tanween should be hidden when they are pronounced with making 
            the sound of ghunnah for approximately two beats of seconds.</p>
        </div>
        <div class="rule-card">
            <img src="" alt="idgham without ghunah">
    ...
    <div class="rule-column">
        ...
        <div class="rule-card">
            <img src="" alt="idgham with ghunnah">
        ...
        <div class="rule-card">
            <img src="" alt="idgham meaning">
            <p><strong>Rule 9:</strong> TheIdgham rules is if after Nun As-Sakinah or Tanween comes any of the Idghaam 
            letters, you will merge the nun Sakinah or Tanween into the letter. 
            The emphasis will be on the succeeding letter because of the presence of Shaddah..</p>
        </div>
    </div>
</div>
